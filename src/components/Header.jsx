        ...
        <section id='header' className='py-[32px]'>
            <Container>
                <div className='flex flex-col lg:flex-row'>
                    ...
                    <div className='lg:w-3/4 w-full lg:justify-start justify-end lg:visible invisible'>
                    ...
                    <div onClick={() => setShow(!show)} className='lg:hidden cursor-pointer text-[#262626] pb-[5px] flex justify-end pe-[10px]'>
                        {show ? <RxCross1 className='cursor-pointer' /> : <FaBars className='cursor-pointer' />}
                    </div>
                    <div className={`z-50 absolute lg:hidden top-24 left-0 w-full bg-white flex flex-col items-center gap-6 ${show ? 'opacity-100' : 'opacity-0'}`}>
                        <ul>
